...
(function () {
  ...
  function buildAgentCard(a) {
    ...
    card.innerHTML = `
      <div style="flex-shrink:0;width:54px;height:54px;border-radius:50%;overflow:hidden;background:#0a2e4c;display:flex;align-items:center;justify-content:center;">
        <img src="${escapeHTML(a.avatar || 'icons/icon-192.png')}" alt="${escapeHTML(a.name)}" style="width:100%;height:100%;object-fit:cover;" onerror="this.style.display='none';this.parentElement.innerHTML='<span style=\\'font-family:Montserrat;font-weight:800;color:#fff;font-size:22px;\\'>${escapeHTML((a.name || '?').slice(0,1))}</span>';" />
      </div>
      <div style="flex:1;min-width:0;">
        ...
        <p style="margin:3px 0 0;font-size:12px;color:rgba(220,230,239,0.7);display:flex;align-items:center;gap:6px;">
