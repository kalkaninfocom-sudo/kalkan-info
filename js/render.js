      ...
      <article class="card group" style="background:white;border-radius:14px;overflow:hidden;box-shadow:0 1px 3px rgba(7,33,54,0.08);border:1px solid rgba(26,94,147,0.06);transition:transform 200ms ease, box-shadow 200ms ease;">
        ...
        <div class="p-4">
          ...
          <div class="flex items-end justify-between gap-2 mt-3">
            ...
            <a href="${mapsHref}" target="_blank" rel="noopener" onclick="event.stopPropagation();" class="flex-shrink-0 inline-flex items-center gap-1.5 bg-sea-50 hover:bg-sea-100 text-sea-800 text-[11px] font-bold px-2.5 py-1.5 rounded-md transition" title="${escape(uiLabel('yolTarifiTitle'))}" aria-label="${escape(name||'')} ${escape(uiLabel('yolTarifi'))}">
      ...
      <article class="card" style="background:white;border-radius:14px;overflow:hidden;box-shadow:0 1px 3px rgba(7,33,54,0.08);border:1px solid rgba(26,94,147,0.06);">
        ...
        <div class="p-4">
          ...
          <div class="flex items-center justify-between mt-4 pt-3 border-t border-ink-700/8 gap-2">
            <a href="https://www.google.com/maps/search/?api=1&query=${encodeURIComponent((name||'')+' Kalkan Antalya')}" target="_blank" rel="noopener" onclick="event.stopPropagation();" class="inline-flex items-center gap-1.5 text-[11px] font-bold px-2.5 py-1.5 rounded-md transition" style="background:#f1f3f4;color:#1a73e8;" onmouseover="this.style.background='#e8eaed';" onmouseout="this.style.background='#f1f3f4';" title="${escape(uiLabel('googleReviewsTitle'))}" aria-label="${escape(name||'')} ${escape(uiLabel('googleReviews'))}">
