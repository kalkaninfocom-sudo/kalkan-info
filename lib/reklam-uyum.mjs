...
// "Her içerik 5 dilde" vizyonu: DE/RU/FR şeffaflık ibareleri (Madde 1 tüm dillerde geçerli).
export const AI_IBARESI_DE = '🤖 Dieser Inhalt wurde mithilfe von KI erstellt.';
export const AI_IBARESI_RU = '🤖 Этот контент создан с помощью искусственного интеллекта.';
export const AI_IBARESI_FR = '🤖 Ce contenu a été créé avec l’aide de l’IA.';
// Dil → ibare eşlemesi (tek doğruluk kaynağı; üreticiler lang geçer).
...
// AI ibaresi zaten var mı? (tüm dillerdeki anahtar sözcükler + hashtag)
const HAS_AI_MENTION = /yapay\s*zek[âa]|#yapayzeka|\byapayzeka\b|\bA\.?I\.?\b|üretken zeka|\bKI\b|künstliche[rn]? Intelligenz|искусственн\w*\s+интеллект|нейросет|intelligence artificielle|\bIA\b/i;
...
export function withAiDisclosure(caption, { hashtags = [], lang = 'tr', isAI = true } = {}) {
  ...
  const line = AI_IBARESI[lang] || AI_IBARESI_TR;
...
export default { withAiDisclosure, hedefliReklamNotu, scanReklamUyum, AI_IBARESI_TR, AI_IBARESI_EN, AI_IBARESI_DE, AI_IBARESI_RU, AI_IBARESI_FR, AI_IBARESI, AI_HASHTAGS };
