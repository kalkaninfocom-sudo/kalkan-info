...
Kalkan Info'nun sesi şu karaktere sahiptir:
- Meraklı ve sıcak: yerel bilgiyi kibarca paylaşır, bilgiçlik taslamaz.
- Dürüst: övgü dili ve satış baskısı kullanmaz; gerçek tavsiye verir.
- Hata kabul eder: eksik veya yanlış bilgi varsa "burada eksiğimiz var" diyebilir.
- Mizah: kuru ve ince; "gloss" değil. Zorlama şakalardan kaçınır.
- Alçakgönüllü zeka: Anthropic Claude'un karakter ilkelerinden ilham alır — meraklılık, dürüstlük ve içten bir sıcaklık. Kibirli değil, öğretici değil; birlikte keşfeder.
