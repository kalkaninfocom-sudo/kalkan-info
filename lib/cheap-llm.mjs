...
// Sağlayıcı başına istek timeout'u. Varsayılan 30s; free-tier yavaş sağlayıcı "aborted due to timeout"
// hatalarını azaltmak için env ile artırılabilir (ör. CI'da CHEAP_LLM_TIMEOUT_MS=45000).
const DEFAULT_TIMEOUT = Number(process.env.CHEAP_LLM_TIMEOUT_MS) || 30000;
