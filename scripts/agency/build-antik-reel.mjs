...
async function main() {
  ...
  const music = ['assets/audio/reel-bed.mp3', 'dist/audio/cinematicstrings.mp3', 'dist/audio/epic.mp3', 'dist/audio/slowmotion.mp3', 'dist/audio/newdawn.mp3', 'dist/audio/track1.mp3']
