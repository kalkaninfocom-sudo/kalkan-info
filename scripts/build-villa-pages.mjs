...
for (const slug of targets) {
  ...
  const repl = {
    ...
    KITCHEN_TITLE_I18N_ATTRS: i18nAttrs(k.titleI18n),
    KITCHEN_INTRO: k.intro || '',
    KITCHEN_INTRO_I18N_ATTRS: i18nAttrs(k.introI18n),
    KITCHEN_ITEMS_GRID: kitchenItemsGrid,
    KITCHEN_IMAGE: kitchenImage,
    SALON_TITLE: s.title || 'Salon',
    SALON_TITLE_I18N_ATTRS: i18nAttrs(s.titleI18n),
    SALON_INTRO: s.intro || '',
    SALON_INTRO_I18N_ATTRS: i18nAttrs(s.introI18n),
    SALON_ITEMS_GRID: salonItemsGrid,
    SALON_IMAGE: salonImage,
    GARDEN_TITLE: g.title || 'Bahçe & Havuz',
    GARDEN_TITLE_I18N_ATTRS: i18nAttrs(g.titleI18n),
    GARDEN_INTRO: g.intro || '',
    GARDEN_INTRO_I18N_ATTRS: i18nAttrs(g.introI18n),
